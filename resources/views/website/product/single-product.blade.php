            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="product-details">
                        ...
                        <h5>Please select size , color & quantity..</h5>
                        <form action="{{route('product.addtocart',['id'=>$product->id])}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="add-to-cart">
                                ...
                                <button type="submit" onclick="function2()" class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> add to cart</button>
                            </div>
                        </form>
    ...
    <div class="section">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                @foreach($products->where('cat_id',$product->cat_id) as $relatedProduct)
                <div class="col-md-3 col-xs-6">
                    <div class="product">
                        <div class="product-img">
                            @foreach(explode('|',$relatedProduct->image) as $key => $image )
                                @if($key==0)
                                    <a href="{{route('product.single',['id'=>$relatedProduct->id])}}"> <img src="{{asset($image)}}" style="width: 100%" alt=""></a>
                                @endif
                            @endforeach
                        ...
                        <div class="add-to-cart">
                            <button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> <a
                                    href="{{route('product.single',['id'=>$relatedProduct->id])}}">add to cart</a></button>
                        </div>
                    </div>
                </div>
                @endforeach
